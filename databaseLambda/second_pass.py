...
def secondPass(max_teams, teams, attendeeId, customer, hash_l, room_list, firstName, fullName, language, role, awsExperience, virtual, timeStamp, l_flag):
    ...
    #Check for any flags
    if l_flag:
        return secondLanguagePass(max_teams, teams, attendeeId, customer, hash_l, room_list, firstName, fullName, language, role, awsExperience, virtual, timeStamp)
...
def secondLanguagePass(max_teams, teams, attendeeId, customer, hash_l, room_list, firstName, fullName, language, role, awsExperience, virtual, timeStamp):
    print("Performing the second language pass")
    #Scan each team
    notComplete = True
    team_num = 0
    for t in teams:
